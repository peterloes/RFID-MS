...
void dbgInit(void)
{
    ...
    /* use X3-3 (PC10) and X3-2 (PC11) for debugging */
...
void dbg1Set(void)
{
    GPIO->P[gpioPortC].DOUTSET = 1 << 10;			//RAGE-DBG
}

void dbg1Clr(void)
{
    GPIO->P[gpioPortC].DOUTCLR = 1 << 10;			//RAGE-DBG
}

void dbg2Set(void)
{
    GPIO->P[gpioPortC].DOUTSET = 1 << 11;			//RAGE-DBG
}

void dbg2Clr(void)
{
    GPIO->P[gpioPortC].DOUTCLR = 1 << 11;			//RAGE-DBG
}

void dbg2Tgl(void)
{
    GPIO->P[gpioPortC].DOUTTGL = 1 << 11;			//RAGE-DBG
}
